        ...
        <div class="product_describe">
            ...
            <div class="product_content">
                ...
                <div class="product_content_features">
                    ...
                    <span>${d.matKinhCamUng}</span>
                </div>
                <div class="product_content_features">
                    <label>Độ phân giải:</label>
                    <span>${d.doPhanGiai}</span>
                </div>
                <div class="product_content_features">
                    <label>Màn hình rộng:</label>
                    <span>${d.manHinhRong}</span>
                </div>
                <div class="product_content_features">
                    <label>Camera sau:</label>
                    <span>${d.cameraSau}</span>
                </div>
                <div class="product_content_features">
                    <label>Quay Phim:</label>
                    <span>${d.quayPhim}</span>
                </div>
                <div class="product_content_features">
                    <label>Hệ điều hành:</label>
                    <span>${d.heDieuHanh}</span>
                </div>
                <div class="product_content_features">
                    <label>Chipset:</label>
                    <span>${d.chipset}</span>
            ...
            <div class="product_order">
                ...
                <input type="number" id="quantity_order" name="quantity_order" readonly value="1" min="1" max="${p.quantity}">
                <a class="fa-solid fa-plus" onclick="increaseQuantity()"></a>
                <br/>
                <label><b>Giá tiền: </b></label>
                <span><b><fmt:formatNumber value="${p.price}" pattern="###,###,###"/> đ</b></span>
                    
                </div>

                <div class="product_order_button">
                    <div class="button_1"><a href="#"><b>MUA NGAY</b></a></div>
                    <div class="button_2"><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></div>
                </div>
            </div>
