CREATE DATABASE DatabaseWeb1 ON  PRIMARY 
( NAME = N'DatabaseWeb1', FILENAME = N'D:\Elearn\DatabaseWeb1.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ) 
LOG ON 
( NAME = N'DatabaseWeb1_log', FILENAME = N'D:\Elearn\DatabaseWeb1_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
 COLLATE Vietnamese_CI_AS

drop database DatabaseWeb1
...
(
	...
	NameNew nvarchar(max) not null,
	ImageNew nvarchar(max) not null,
...
(
	...
	NewId int references News(NewId)
)
