...
public class Describe {
	...
	public String toString() {
		return "Describe [DesId=" + DesId + ", MatKinhCamUng=" + MatKinhCamUng + ", DoPhanGiai=" + DoPhanGiai
				+ ", ManHinhRong=" + ManHinhRong + ", CameraSau=" + CameraSau + ", QuayPhim=" + QuayPhim
				+ ", HeDieuHanh=" + HeDieuHanh + ", Chipset=" + Chipset + ", Ram=" + Ram + ", Rom=" + Rom + ", Pin="
				+ Pin + ", ThongTinSanPham=" + Arrays.toString(ThongTinSanPham) + ", DacDiemNoiBat="
				+ Arrays.toString(DacDiemNoiBat) + ", NewId=" + NewId + "]";
	}
