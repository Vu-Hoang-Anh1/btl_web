...
<head>
    ...
    <link rel="stylesheet" href="../access/stylecss/styleSignup.css">
    <link rel="stylesheet" href="../access/themify-icons-font/themify-icons/themify-icons.css">
...
<%-- <%
    ...
    <div id="signup-container">
        ...
        <div class="login_logo_video">
            <video autoplay loop>
                <source src="../access/img/img_signup/Video chưa đặt tên ‐ Được tạo bằng Clipchamp (1).mp4" >
            </video>
