...
<link rel="stylesheet" href="${pageContext.request.contextPath}/view/access/stylecss/product.css">
			...
			<a href="Servlet_product_describe?ProId=${p}" target="_blank" class="product_a">
				...
				<div class="product_button">
					<div class="product_button_detail">
						<a href="Servlet_product_describe?ProId=${p}" target="_blank"><b>CHI TIẾT
						</b></a>
					</div>
